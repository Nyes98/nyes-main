...
// BOM / DOM feat.MVC(Model View Controler)

// Node, Tag, Element란 무엇인가?
// Tag는 HTML에서 사용하는 명령어의 이름을 뜻했다. ex)html, body, div, ...
...
// Tag && Element의 차이 : Tag는 이름 그 자체다. Element는 객체다. 즉, Javascript에서 HTML 구조를 수정하거나 내용을 추가하거나 등등에서 사용하는 Tag에 대한 객체다.
...
// Javsscript 프로토타입 형태로 되어있다.
// Javascript는 기본적으로Node를 기준으로 하고있다.
