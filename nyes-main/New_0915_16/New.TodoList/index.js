...
// const로 list를 초기화한 이유 : 메서드(함수)를 호출할 때마다 javascript는 해당 코드를 실행하기 때문에 실행을 최소하 하기 위해서 변수에 반환값(retrun)을 정의하여 이후 다시 찾지 않고 바로 쓸 수 있도록 한다.
