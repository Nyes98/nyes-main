...
const mapStateToProps = (state, props) => {
  return { count2: state.count2, ...props }; // props는 app.js에서 받는 것
...
// mapStateToProps 콜백함수와 mapStateToProps 콜백함수의 return 값은 객체로 내보낸다.
// mapStateToProps 콜백함수의 매개변수로는 state와 props를 받는다.
//  - state는 store(redux)의 state이다.
//  - props는 상위 컴포넌트(App.js)에서 전달한 props이다
// mapDispatchToProps 콜백함수의 매개변수로는 dispacth를 받는다.
//  - dispatch는 store의 dispatch 메서드이다.
// mapStateToProps 콜백함수와 mapDispatchToProps 콜백함수의 return 값 객체는 합쳐져서 다음 컴포넌트(Count2Container)에
