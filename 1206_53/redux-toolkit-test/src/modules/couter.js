...
const counterSlice = createSlice({
  ...
  name: "cococo", // action의 이름, action의 tpye에 '액션명/리듀서명' 으로 표기된다.
...
// createSlice는 action을 자동으로 만들어준다. (action은 함수다.)
// dispatch에 action에 createSlice로 생성된 actions을 사용한다.
export const reducer = counterSlice.reducer;
// store에 reducer로 createSlice로 생성된 reducer를 사용한다.
